...
plt.scatter(X[:,0],X[:,1],s=1,color='xkcd:orangish red',label='target samples',zorder = 10)
plt.scatter(Z_gen[:,0],Z_gen[:,1],s=1,color='xkcd:grass green',label='reference samples', zorder = 5)
plt.xlabel('dimension 1 ($x_{1}$ or $z_{1}$)')
plt.ylabel('dimension 2 ($x_{2}$ or $z_{2}$)')
plt.title('forward map $\pi$ to $\eta$')
plt.xlim(-3,3)
plt.ylim(-3,3)
plt.legend()
...
# Now plot the results
plt.figure(figsize=(7,7))
plt.scatter(X_gen[:,0],X_gen[:,1],s=1,color='xkcd:orangish red',label='target samples',zorder = 10)
plt.scatter(Z[:,0],Z[:,1],s=1,color='xkcd:grass green',label='reference samples', zorder = 5)
plt.xlabel('dimension 1 ($x_{1}$ or $z_{1}$)')
plt.ylabel('dimension 2 ($x_{2}$ or $z_{2}$)')
plt.title('inverse map $\eta$ to $\pi$')
plt.xlim(-3,3)
plt.ylim(-3,3)
plt.legend()
...
plt.scatter(X_cond[:,0],X_cond[:,1],s=1,color='xkcd:orangish red',label='conditional samples', zorder = 10, alpha = 0.01)
