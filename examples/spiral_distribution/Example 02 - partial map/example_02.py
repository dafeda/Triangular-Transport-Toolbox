...
if 'dict_coeffs_order='+str(maxorder)+'_partial.p' not in os.listdir(root_directory):
    ...
    # Save the dictionary
    pickle.dump(dict_coeffs,open(os.path.join(root_directory, 'dict_coeffs_order='+str(maxorder)+'_partial.p'),'wb'))
    ...
    dict_coeffs = pickle.load(open(os.path.join(root_directory, 'dict_coeffs_order='+str(maxorder)+'_partial.p'),'rb'))
